    ...
    public void sendAnnounce(Announce announce) {
        for (String s : announce.getMessages()) {
            ...
            if (matcher.find()) {
                ...
                if(parts.length!=0){
                    builder.append(ChatColor.translateAlternateColorCodes('&', hexColor(parts[0])));
                }
                builder.append(web);
                if(parts.length!=0){
                    builder.append(ChatColor.translateAlternateColorCodes('&', hexColor(parts[1])));
                }
            } else {
                builder.append(ChatColor.translateAlternateColorCodes('&', hexColor(s)));
            }
